...
COUNTRIES_DATA = [
  ...
  { code: "MEX", emoji: "🇲🇽", size: 20, color: "#009163", group_name: "A" },
  { code: "RSA", emoji: "🇿🇦", size: 20, color: "#00aa6b", group_name: "A" },
  { code: "KOR", emoji: "🇰🇷", size: 20, color: "#CD2E3A", group_name: "A" },
  { code: "CZE", emoji: "🇨🇿", size: 20, color: "#1760b0", group_name: "A" },
  { code: "CAN", emoji: "🇨🇦", size: 20, color: "#FF0000", group_name: "B" },
  { code: "BIH", emoji: "🇧🇦", size: 20, color: "#0031d0", group_name: "B" },
  { code: "QAT", emoji: "🇶🇦", size: 20, color: "#c11d4e", group_name: "B" },
  ...
  { code: "NZL", emoji: "🇳🇿", size: 20, color: "#0032af", group_name: "G" },
  { code: "ESP", emoji: "🇪🇸", size: 20, color: "#AA151B", group_name: "H" },
  { code: "CPV", emoji: "🇨🇻", size: 20, color: "#004ecd", group_name: "H" },
  { code: "KSA", emoji: "🇸🇦", size: 20, color: "#00974a", group_name: "H" },
  { code: "URU", emoji: "🇺🇾", size: 20, color: "#5CBEF0", group_name: "H" },
  { code: "FRA", emoji: "🇫🇷", size: 20, color: "#0031d0", group_name: "I" },
  { code: "SEN", emoji: "🇸🇳", size: 20, color: "#00ba58", group_name: "I" },
  { code: "IRQ", emoji: "🇮🇶", size: 20, color: "#00aa55", group_name: "I" },
  { code: "NOR", emoji: "🇳🇴", size: 20, color: "#EF2B2D", group_name: "I" },
  { code: "ARG", emoji: "🇦🇷", size: 20, color: "#75AADB", group_name: "J" },
  { code: "ALG", emoji: "🇩🇿", size: 20, color: "#008947", group_name: "J" },
  { code: "AUT", emoji: "🇦🇹", size: 20, color: "#ED2939", group_name: "J" },
  { code: "JOR", emoji: "🇯🇴", size: 20, color: "#00aa55", group_name: "J" },
  { code: "POR", emoji: "🇵🇹", size: 20, color: "#008e00", group_name: "K" },
  ...
  { code: "GHA", emoji: "🇬🇭", size: 20, color: "#009558", group_name: "L" },
